...
The current research dataset was reviewed and integrated on 2026-08-10.
...
- `03_WebApp/data/question_bank_1000.json` is preserved as a bilingual future bank. Automated checks cover structure and branch targets, not content validity; the live interview does not import it.

## Web-app data record

- On 2026-08-11, the web app was aligned with this dataset. The active prototype now has a 12-route catalogue and province-aware nearby-institution views.
- `data/nearby.json` contains 77 provinces and 1,961 options from the documented MHESI/OVEC source pipeline.
