...
> **สถานะใน FutureMe 0.2.0 · ตรวจขอบเขต 11 สิงหาคม 2026:** ชุดนี้ยังเป็นงานวิจัยและตัวอย่าง ไม่ได้เชื่อมเป็น production RAG ของเว็บแอปปัจจุบัน ส่วน RAG ใน `02_Backend` เก็บเฉพาะ metadata สถานะของ repository และถูกระบุชัดว่าไม่พร้อมใช้งานจริง
