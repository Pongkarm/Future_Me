...
>
> สถานะใน FutureMe 0.2.0 · ตรวจขอบเขตเมื่อ 11 สิงหาคม 2026: โค้ดในโฟลเดอร์นี้ไม่ถูกเรียกจากเว็บแอปปัจจุบัน และห้ามใช้เป็นหลักฐานว่า production RAG พร้อมใช้งานแล้ว
