...
export const en = {
  ...
  compare: {
    ...
    caveat:
      "Relative cost, whether you would need to move, and time before earning are unverified team estimates. The engine does not use them to score, rank, remove, or prefer a route. Treat them only as prompts, and check anything you would act on against the institution's current official page.",
    ...
    rowLearningStyle: "Learning-environment affinity ({pct}%)",
