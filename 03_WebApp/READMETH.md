...
|---|---|---|
| **1 · ทบทวน** | ตอบคำถามความสนใจ 30 ข้อและคำถามบริบท 5 ข้อ โดยคำตอบแรกเปลี่ยนเพียงลำดับคำถามความสนใจเดิม 2 ข้อ จากนั้นทบทวนคำตอบทั้งหมด | โปรไฟล์ความสนใจรูปแบบ RIASEC ชั่วคราวและข้อจำกัดที่มีผลจริง |
...
| **4 · เทียบ** | เปรียบเทียบทุกเส้นทางด้วยเกณฑ์จากหลักฐาน 3 ข้อ และแสดงค่าประมาณเชิงปฏิบัติไว้ให้ตรวจสอบต่อ | ข้อแลกเปลี่ยนและข้อมูลที่ยังขาด |
| **5 · ลงมือ** | เปลี่ยนหนึ่งเส้นทางเป็นแผน 30 วันที่ประกอบด้วยงานเล็ก ๆ และเปลี่ยนใจได้ | หลักฐานใหม่จากการลงมือ |

<p align="center">
  <a href="assets/screenshots/app/routes-desktop.png"><img src="assets/screenshots/app/routes-desktop.png" alt="หน้าเส้นทางปัจจุบัน พร้อมหลักฐานของหลายทางเลือก" width="92%"></a>
</p>
...
<td width="50%" valign="top">
<a href="assets/screenshots/app/interview-desktop.png"><img src="assets/screenshots/app/interview-desktop.png" alt="หน้าสัมภาษณ์ปัจจุบันพร้อมมาสคอต FutureMe ภาษาอังกฤษ ธีมมืด"></a><br>
...
<td width="50%" valign="top">
<a href="assets/screenshots/app/plan-desktop.png"><img src="assets/screenshots/app/plan-desktop.png" alt="หน้าแผน 30 วันปัจจุบันของ FutureMe"></a><br>
...
| **แบบสำรวจ** | คำถามกิจกรรมความสนใจ 30 ข้อ มิติ RIASEC ละ 5 ข้อ ใช้สเกลชอบ/ไม่ชอบ 5 ระดับ โดยคำตอบแรกเลื่อนคำถามที่ทบทวนแล้ว 2 ข้อมาแสดงต่อทันทีตามกฎที่กำหนด |
| **แอนิเมชันมาสคอต** | เปิดเป็นค่าเริ่มต้นตลอดเส้นทาง และมีตัวเลือกที่บันทึกไว้เพื่อกลับไปใช้การตั้งค่าการเคลื่อนไหวของระบบ |
...
| **สัญญาขอบเขตข้อมูลการศึกษา** | ขอบเขต Institution / Program / Admission / Financial / Location แหล่งที่ตรวจ ช่องว่าง และข้อจำกัดการใช้ตัดสินใจ |
...
> **ขอบเขตข้อมูลข้าม branch ตรวจเมื่อ 16 สิงหาคม 2026:** Kong19565 เพิ่มแบบสอบถามลำดับคงที่
> 41 ข้อ (ความสนใจ 30 + self-efficacy 6 + บริบท 5) ดัชนีหลักสูตร 23,257 ระเบียน ครอบคลุม
> 993 สถาบันและ 269 สาขา และตัวจับคู่แบบ deterministic ที่แสดงได้สูงสุด 5 หลักสูตร
> Panussu ยังไม่ได้ import ไฟล์เหล่านี้ และชุดข้อมูลยังไม่มีค่าเล่าเรียนที่ผู้เรียนจ่าย เกณฑ์ TCAS
> หรือทุนที่ตรวจสอบแล้ว ดู [ตารางเปรียบเทียบใน README หลัก](../READMETH.md#ข้อมูลจาก-kong19565-ที่ตรวจแล้ว)
...
flowchart LR
    ...
    E -->|"พอ"| G["ตัวกรองระดับการศึกษา<br/>ค่าปฏิบัติยังไม่ใช้ตัดสิน"]
    G --> H["เกณฑ์ถ่วงน้ำหนัก<br/>สามข้อ"]
    H --> I["0–3 เส้นทาง"]
    I --> J["เปรียบเทียบ"]
    J --> K["แผน 30 วัน"]
...
|---|---:|---|
| ความสนใจ | 50% | ความคล้ายของรูปทรงโปรไฟล์ RIASEC ระหว่างผู้เรียนกับเส้นทาง |
| จุดแข็ง | 30% | หลักฐานจากภารกิจที่ทำเสร็จ |
| ความสอดคล้องกับสภาพแวดล้อมการเรียนรู้ | 20% | นำโปรไฟล์จากการสัมภาษณ์มาเทียบกับสภาพแวดล้อมของเส้นทาง |

ค่านี้เป็นการประมาณที่ทีมกำหนดขึ้น ไม่ใช่แบบทดสอบ “สไตล์การเรียนรู้” และไม่ใช่หลักฐานอิสระ
...
- ระดับการศึกษาเป็นเกณฑ์ความเหมาะสมที่ใช้ในปัจจุบัน ส่วนค่าใช้จ่าย การย้ายที่อยู่ เวลา และความยืดหยุ่นจะไม่ใช้ให้คะแนน จัดลำดับ หรือตัดเส้นทางออกจนกว่าจะมีข้อมูลระดับหลักสูตรที่ยืนยันได้
...
- กฎจากคำตอบแรกเปลี่ยนเพียงลำดับคำถามเดิม ไม่ใช่ CAT หรือ IRT และยังไม่มีหลักฐานว่าช่วยเพิ่มความแม่นยำ
- ชุดข้อมูลสองภาษาทดลอง 1,000 แถวสร้างจากข้อความตั้งต้น 148 ข้อ โดยบางข้อความซ้ำสูงสุด 19 ครั้ง ชุดนี้ผ่านการตรวจโครงสร้างแต่ยังเป็นข้อมูลวิจัยและไม่ได้ถูก import เข้าแบบสัมภาษณ์ปัจจุบัน
...
```bash
npm run verify       # ตรวจข้อมูล + typecheck + lint + tests + production build
