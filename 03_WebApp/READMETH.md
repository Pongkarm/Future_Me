...
|---|---|---|
| **1 · ทบทวน** | ตอบคำถามความสนใจ 30 ข้อและคำถามบริบท 5 ข้อ โดยคำตอบแรกเลือกคำถามต่อยอด 2 ข้อให้แสดงทันที จากนั้นทบทวนคำตอบทั้งหมด | โปรไฟล์ความสนใจรูปแบบ RIASEC ชั่วคราวและข้อจำกัดที่มีผลจริง |
...
- กฎเลือกคำถามต่อยอดจากคำตอบแรกเปลี่ยนเฉพาะลำดับ ไม่ใช่ CAT หรือ IRT และยังไม่มีหลักฐานว่าช่วยเพิ่มความแม่นยำ
