...
import "./globals.css";
// After globals.css on purpose. The mascot styles element-level selectors, so
// they must land after Tailwind's preflight; a CSS @import could not express
// that ordering because @import has to come first in a stylesheet.
import "./mascot.css";
