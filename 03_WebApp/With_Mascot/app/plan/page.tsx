...
export default function PlanPage() {
  ...
  const result = useMemo<Recommendation | null>(
    () => (session ? recommend(session.interview, session.mission, undefined, {
  ...
  return (
    <Shell step={5}>
      <div className="mb-6 flex items-start gap-4">
        {/* Decorative — the eyebrow and heading already announce the plan. */}
        <FutureMeMascot
          emotion="very-happy"
          pose="celebrate"
          size={96}
      ...
      <div className="mb-6">
        <Notice tone="warning" title={t.plan.exploratoryTitle} mascot>
