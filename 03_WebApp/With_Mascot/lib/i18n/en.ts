...
export const en = {
  ...
  landing: {
    ...
    // Landing intro and the two form choices.
    introTitle: "Let's find out what fits you.",
    introBody:
      "I'll ask about activities you enjoy — not what you're good at, and not what you should do. Pick the answer that feels most like you. There are no right or wrong answers, and you can change any of them later.",
    chooseLength: "How many questions?",
    shortTitle: "Quick version",
    shortMeta: "{n} questions · about 4 minutes",
    shortBody: "A rough picture, enough to start exploring.",
    fullTitle: "Full version",
    fullMeta: "{n} questions · about 8 minutes",
    fullBody: "A steadier picture, with more evidence behind each dimension.",
    shortCaveat:
      "The quick version asks three questions per interest area instead of five, so its picture is rougher. You can switch to the full version at any time.",
    startShort: "Start the quick version",
    startFull: "Start the full version",
  ...
  /**
   * Alternative text for the mascot, used only where its state says something
   * the surrounding copy does not. Decorative mascots — the faces on the
   * interest scale, the character beside a heading that already reads
   * "Your plan" — take no label at all and are hidden from assistive
   * technology instead.
   */
  mascot: {
    thinking: "FutureMe is working through your answers",
  },

  /**
   * The Buddy's dialogue for the conversational assessment.
   *
   * Two rules hold this section together, and `tests/unit/buddy-script.test.ts`
   * enforces both:
   *
   * 1. Nothing before the result may characterise the learner. The
   *    acknowledgements confirm that an answer landed; they do not say what it
   *    means. Three answers cannot support "you seem practical", and the engine
   *    will not recommend anything until 23 of 30 items are answered.
   * 2. Result copy is hedged. "Your answers suggest", never "you are".
   */
  buddy: {

    consentTitle: "Before we start",
    consentStorage:
      "Your answers stay in this browser. Nothing is sent to a server and nobody else can see them. You can delete everything at any time.",
    consentLimits:
      "This is a research-informed prototype, not a validated test and not a diagnosis. It is one way to think about your options, not a limit on them.",
    consentStart: "I understand — start",
    consentPrivacy: "How my data is used",

    stageInterests: "Interests",
    stageAboutYou: "About you",
    progress: "{stage} · {done} of {total}",
    progressLabel: "Assessment progress",

    // Content-free by design. See the section comment.
    ack1: "Got it.",
    ack2: "Thanks — noted.",
    ack3: "That's helpful.",
    ack4: "Okay, next one.",

    typing: "Buddy is typing",
    buddySaid: "Buddy said",
    youAnswered: "You answered",
    edited: "changed",

    reviewIntro:
      "Before I put this together — here's what you told me. Change anything that doesn't look right.",
    reviewEdit: "Change",
    reviewSubmit: "That all looks right",
    reviewIncomplete:
      "I still need {missing} more interest answers before I can suggest anything. Want to finish those?",
    reviewGoToMissing: "Finish the missing ones",
    reviewCounter: "{answered} of {total} interest questions answered",

    resultIntro:
      "Thanks for sharing your answers. I found a few patterns that might help you see which environments and activities feel most natural to you.",
    resultLimits:
      "Your answers suggest directions worth exploring — not a fixed result. This can change as you gain new experiences, and it should never narrow what you're allowed to try.",
    resultNext: "See what this could mean",
    resultRetake: "Answer again",
    resultReview: "Look back at my answers",

    back: "Back",
    restart: "Start again",
    restartConfirm: "Start again from the first question? Your answers will be cleared.",
    deleteData: "Delete my answers",
    deleteConfirm: "Delete everything saved in this browser? This cannot be undone.",
    review: "Review my answers",
    cancel: "Cancel",

    resumeTitle: "Welcome back.",
    resumeBody: "You were on question {position} of {total}.",
    resumeContinue: "Continue",

    errorStorage:
      "I can't save your progress in this browser, so it won't be here if you leave. You can still finish now.",
    errorLoad: "I couldn't read your saved conversation, so I've rebuilt it from your answers.",

    /* The result framework. Everything below is rendered from what the engine
       already computes — no second opinion about the learner is formed here. */
    profileTitle: "What your answers lean toward",
    profileLead:
      "Ordered by how strongly your answers pointed there. This describes the answers you gave, not a verdict about who you are.",
    profileTop: "strongest",
    profileFlat:
      "Your answers were fairly even across all six areas. That is a real result, not a failure — it often means you have not had the chance to try enough different things yet.",

    basisTitle: "What this rests on",
    basisAnswered: "{answered} of {total} interest questions answered",
    basisFormShort: "Quick version — 3 questions per area, so this is a rough read",
    basisFormFull: "Full version — 5 questions per area",
    basisMissionTodo: "No task tried yet — that is the single biggest thing missing",
    basisMissionDone: "One task tried, which is real behaviour rather than a stated preference",
    basisEvidence: "Evidence so far: {level}",

    pathTitle: "Where to go from here",
    pathLead: "Four steps. Each one adds something the last could not tell you.",
    path1Title: "Try one real task",
    path1Body: "Twenty minutes. It tests what you said against what you actually do.",
    path2Title: "See your routes",
    path2Body: "Up to three study routes, never ranked, with the evidence behind each.",
    path3Title: "Compare them",
    path3Body: "Side by side on cost, time and how open they leave your options.",
    path4Title: "Build a 30-day plan",
    path4Body: "Small steps you can start this week, including what to find out.",
    pathNext: "Next",
    pathDone: "Done",
    pathStart: "Start step {n} →",

    thinTitle: "Not enough to suggest routes yet",
    thinBody:
      "That is deliberate. Suggesting a direction from this little would be guessing, and a guess dressed as a result is worse than no result.",
    thinFix: "Finish the missing questions",

    limitsTitle: "What this cannot tell you",
  },
};
