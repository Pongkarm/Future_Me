...
> **สถานะ:** `design_assumption` — mockup และ journey ยังไม่ใช่ภาพจากระบบที่รันได้

[← Research](../01_Evidence/04_Product_Evidence_Synthesis.md) · [Back to README](../README.md) · [Next: AI System →](../05_AI_Engineering/01_FutureMe_AI_Design.md)
...
flowchart TD
    ...
    S --> X["Raw transcript<br/>private by default"]
...
| **Raw chat transcript** | ● | ปิดโดยค่าเริ่มต้น | ปิดโดยค่าเริ่มต้น |

Consent is per-recipient, visible in the interface, and revocable. Any safeguarding exception
or legally required disclosure needs a separate policy, audit trail and age-appropriate notice;
the product must not promise “never” before that policy is reviewed.
...
- A safety escalation path for distress signals surfaced during the interview is **specified but
  not yet implemented** — see [07 · Roadmap](04_Product_Roadmap.md).
...
| | |
|---|---|
| ![Landing](../90_Assets/Pre_Present/screenshots/01-landing-desktop.png) | ![Interview](../90_Assets/Pre_Present/screenshots/02-socratic-interview.png) |
| **Landing** — three routes, not one answer | **Socratic interview** — adaptive dialogue |
| ![Routes](../90_Assets/Pre_Present/screenshots/03-three-routes.png) | ![Dashboard](../90_Assets/Pre_Present/screenshots/04-counselor-dashboard.png) |
