...
- **เครื่องมือ:** FastAPI, Chroma/FAISS, sentence-transformers, `../../08_Examples/Thai_AI_System_Research/`
...
- **เครื่องมือ:** RAGAS, `10_`, `../../08_Examples/Thai_AI_System_Research/evaluation_example.py`
...
- **เครื่องมือ:** peft, bitsandbytes, trl, `07_`, `../../08_Examples/Thai_AI_System_Research/lora_training_example.py`
