...
> โค้ดทั้งหมดอยู่ใน `../../08_Examples/Thai_AI_System_Research/` — คู่มือนี้อธิบายลำดับ อ่านคู่กับไฟล์โค้ด
...
### 3) เตรียมเอกสาร
- วางไฟล์ `.txt`/`.md`/`.pdf` ภาษาไทยไว้ในโฟลเดอร์ `../../08_Examples/Thai_AI_System_Research/data/`
...
> อ่านต่อ: `16_Research_Papers_and_References.md` และเริ่มที่ `../../08_Examples/Thai_AI_System_Research/`
