...
> **สถานะในคลังรวม:** `technical_reference` — ใช้เป็นคู่มือวิศวกรรม ไม่ใช่หลักฐานว่า FutureMe implement component เหล่านี้แล้ว  
...
| [`../../08_Examples/Thai_AI_System_Research/`](../../08_Examples/Thai_AI_System_Research/) | โค้ดตัวอย่าง Python (ingestion, vector search, RAG, LoRA, evaluation) |
...
5. `15_Prototype_Guide.md` + โฟลเดอร์ `../../08_Examples/Thai_AI_System_Research/`
...
- โค้ดใน `../../08_Examples/Thai_AI_System_Research/` เน้นให้ **เข้าใจ workflow** มากกว่าความสมบูรณ์เชิงวิศวกรรม — อ่าน [`README.md`](../../08_Examples/Thai_AI_System_Research/README.md) และ comment ก่อนรัน

## เริ่มต้นเร็ว (Quickstart)
ดู `15_Prototype_Guide.md` และรัน:
```bash
cd ../../08_Examples/Thai_AI_System_Research
