...
<p align="center">
  <a href="index.html"><b>🌐 Open Interactive System Showcase Web App (คลิกเปิดดูเว็บจำลองสถาปัตยกรรมและ RAG Audit Hub)</b></a>
</p>
...
<sub>TDRI 2025: 56% work outside their field, 27% below qualification. OECD: 35–40% global mismatch. WEF 2025: 39% of skill sets change by 2030.</sub>
...
**What we removed**
<sub>Unsupported figures were audited out (e.g. 68.6% overall mismatch, 304,378 postings updated to 756,300, wage penalty, blanket experience requirement, and misquoted WEF 44%).</sub>
...
| [08 · Pitch Deck Script](docs/08-pitch-deck-script.md) | 5-minute pitch script, scene-by-scene timing, advisor Q&A defense guide |
