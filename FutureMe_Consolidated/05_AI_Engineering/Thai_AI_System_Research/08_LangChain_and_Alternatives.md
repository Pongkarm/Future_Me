...
โค้ดใน `../../08_Examples/Thai_AI_System_Research/` ของฐานความรู้นี้ **เขียนแบบ Python ตรง ๆ เป็นหลัก** (ใช้ `sentence-transformers` + FAISS/Chroma) เพื่อให้เห็น workflow ชัดโดยไม่ผูกกับ API ของ framework ที่เปลี่ยนบ่อย — เมื่อเข้าใจ flow แล้วจึงย้ายไป LlamaIndex/LangChain ได้ง่าย
