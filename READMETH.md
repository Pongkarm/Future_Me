...
### ข้อมูลเพิ่มเติมจากสาขาอ้างอิง Kong19565

[สาขา Kong19565](https://github.com/Pongkarm/Future_Me/tree/Kong19565) มีงานเพิ่มเติมจาก checkout
ของ `Panussu` นี้ แต่ยังไม่ควรถือว่าเป็นส่วนหนึ่งของระบบในสาขาปัจจุบัน:

- **เส้นทางสัมภาษณ์แบบปรับตามคำตอบ:** heuristic แบบ deterministic เลือกข้อถัดไปจากโปรไฟล์
  30 ข้อเดิมและแสดงสัญญาณความมั่นใจ/หยุดก่อนจบ แต่ยังไม่มีหลักฐานว่า CAT ให้ความแม่นยำที่ผ่านการตรวจสอบ
- **ค้นหาสถานศึกษาใกล้เคียง:** ค้นตามจังหวัดจากข้อมูล 77 จังหวัดของทะเบียน สอศ. และ อว. ระบบบอกว่า
  มีสถานศึกษาใดและอยู่ในช่วงระยะทางใด ไม่ใช่คำแนะนำหรือการตรวจสอบสิทธิ์รับเข้า
- **คลังข้อมูลงานวิจัยที่ขยายขึ้น:** มีแค็ตตาล็อก 12 เส้นทางและไฟล์คลังคำถาม 1,000 ข้อพร้อม metadata
  ของแหล่งที่มาจาก 18REST, O*NET 28.2, ESCO v1.2, มาตรฐานอาชีวศึกษาของ สอศ. และ myTCAS70
  แต่การสัมภาษณ์ที่รันอยู่ยัง import `data/questions.json` ซึ่งมี 30 ข้อ ดังนั้นไฟล์ 1,000 ข้อ
  จึงยังไม่ใช่หลักฐานว่าแบบประเมิน 1,000 ข้อพร้อมใช้หรือผ่านการตรวจสอบแล้ว สาขานี้ยังมีป้าย
  Golden Fit, Growth Area และ Burnout Risk ซึ่งเป็น heuristic ในการออกแบบ ไม่ใช่การวัด
  skill efficacy ที่ผ่านการตรวจสอบ
- **การป้องกัน API:** endpoint แชตและการเรียบเรียงคำอธิบายมีตัวจำกัดคำขอและงบ provider แยกกันใน process
  กลไกนี้ควบคุมงบ ไม่ใช่การยืนยันตัวตน และจะเริ่มนับใหม่เมื่อรีสตาร์ตโปรเซส
...
แหล่งอ้างอิง ปัจจุบันค่าใช้จ่าย การย้ายที่อยู่ ระยะเวลาก่อนมีรายได้ ความยืดหยุ่น จุดแข็ง
และข้อจำกัดยังเป็นค่าประมาณของทีม จึงต้องแทนที่ก่อนทดลองกับผู้เรียน ดูรายละเอียดใน
