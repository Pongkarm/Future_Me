...
<p align="center">
  ...
  ทบทวน → ทดลอง → สำรวจ → เปรียบเทียบ → ลงมือทำ
</p>
...
<p align="center"><sub>ตรวจทานเอกสารและข้อมูลเทียบข้าม branch ล่าสุดเมื่อ 16 สิงหาคม 2026 ส่วนผลตรวจระบบครบชุดล่าสุดยังเป็นวันที่ 11 สิงหาคม 2026</sub></p>
...
ระบบประกอบด้วยคำถามทบทวนความสนใจ 30 ข้อ ซึ่งคำตอบแรกเปลี่ยนเพียงลำดับคำถามเดิม 2 ข้อ
คำถามบริบท 5 ข้อ ภารกิจจำลองสั้น ๆ การเปรียบเทียบสมมติฐานเส้นทางเรียนหรืออาชีพได้สูงสุด 3 ทาง
แบบอธิบายเหตุผลได้ การค้นหาสถานศึกษาใกล้เคียงตามจังหวัด และแผนทดลอง 30 วันที่เปลี่ยนใจได้
...
| **เดโมนี้ใช้อะไรบ้าง?** | คำถามความสนใจ 30 ข้อ + คำถามบริบท 5 ข้อ ภารกิจ 3 แบบ เส้นทางตัวอย่าง 12 ทาง และแถวข้อมูลสถานศึกษาใกล้เคียง 1,961 แถว ครบทั้ง 77 จังหวัด |
...
flowchart LR
    ...
    K["ข้อมูลงานวิจัยจาก branch Kong"] -. "ตรวจสอบก่อนเชื่อม" .-> B
...
```mermaid
flowchart TD
    A["เริ่มแบบผู้เยี่ยมชม<br/>ไม่ต้องมีบัญชี"] --> B["1 · ทบทวน<br/>คำถามความสนใจตามกรอบ RIASEC 30 ข้อ<br/>คำตอบแรกเลื่อนคำถามเดิม 2 ข้อมาแสดงต่อ"]
    B --> C["คำถามบริบทบังคับ 4 ข้อ<br/>+ คำถามปลายเปิดทางเลือก 1 ข้อ<br/>ตรวจทานและแก้ไขคำตอบทั้งหมด"]
    C -->|"ตอบความสนใจอย่างน้อย 23 ข้อ<br/>และตอบบริบทบังคับครบ"| D["2 · ทดลอง<br/>ระบบกฎเสนอ 1 จาก 3 ภารกิจ<br/>12 นาที · 4 ขั้น · ผู้เรียนเปลี่ยนภารกิจได้"]
    D --> E{"ตรวจหลักฐานด้วยกฎที่ทำซ้ำได้"}
    E -->|"หลักฐานน้อยเกินไปหรือคะแนนกระจายไม่พอ"| F["ไม่เสนอเส้นทาง<br/>พร้อมอธิบายว่าขาดหลักฐานใด"]
    F --> G["กลับไปแก้คำตอบหรือทำภารกิจใหม่"]
    G --> B
    G --> D
    E -->|"หลักฐานเพียงพอ"| H["3 · สำรวจ<br/>สมมติฐาน 0–3 ทางจากแค็ตตาล็อก 12 ทาง<br/>กรองระดับการศึกษา · ผลสูสี · ความขัดแย้ง · แหล่งที่มา"]
    H -. "ทางเลือก" .-> N["เลือกจังหวัดด้วยตนเอง<br/>77 จังหวัด · 1,961 แถวแสดงผล<br/>ไม่เปลี่ยนผลเส้นทาง"]
    H --> I["4 · เปรียบเทียบ (ทางเลือก)<br/>ความสนใจ 50% · หลักฐานจากภารกิจ 30%<br/>ความสอดคล้องกับสภาพแวดล้อมการเรียนรู้ 20%"]
    I --> J["ค่าใช้จ่าย · การย้ายถิ่น · ระยะเวลาก่อนมีรายได้ · ความยืดหยุ่น<br/>แสดงเพื่อชวนตรวจสอบ แต่ไม่ใช้ตัดสินเส้นทาง"]
    J --> K["5 · ลงมือทำ<br/>เลือก 1 เส้นทาง<br/>แผนทดลอง 30 วันแบบเปลี่ยนใจได้ แบ่งเป็น 4 สัปดาห์"]
    H -->|"เลือกเส้นทางแล้วสร้างแผนได้ทันที"| K
    K --> L["บันทึกความคืบหน้าไว้ในเบราว์เซอร์"]
    L -. "วางแผนไว้ แต่ยังไม่พัฒนา" .-> P["บัญชีผู้ใช้ · ฐานข้อมูลและ RAG บนคลาวด์<br/>แดชบอร์ดครูแนะแนว · แฟ้มสะสมผลงาน TCAS"]
...
แผนภาพนี้แสดงขั้นตอนที่ทำงานอยู่จริงใน branch **Panussu** ส่วน AI เสริมมีหน้าที่อธิบายหรือเรียบเรียง
ข้อความเท่านั้น ไม่ได้เลือกเส้นทาง แบบสอบถามคงที่ 41 ข้อและตัวจับคู่หลักสูตรใน branch Kong
ยังเป็นงานแยกและยังไม่ถูกนำมาใช้ในระบบนี้
...
| **ข้อมูลเดโม** | คำถามความสนใจ 30 ข้อ + คำถามบริบท 5 ข้อ ภารกิจ 3 แบบ เส้นทางตัวอย่าง 12 ทาง และข้อมูลสถานศึกษาใกล้เคียง 1,961 แถว ครบ 77 จังหวัด | 🟡 ข้อมูลต้นแบบที่มีฐานงานวิจัย |
...
| **งานวิจัยจาก branch Kong** | ดัชนีหลักสูตร 23,257 ระเบียน คำถาม self-efficacy 6 ข้อ และตัวจับคู่หลักสูตรแบบ deterministic แยกต่างหาก | 🟡 มีใน Kong19565 แต่ยังไม่เชื่อมเข้า Panussu |
...
### ข้อมูลจาก Kong19565 ที่ตรวจแล้ว

<details>
<summary><strong>เปิดดูข้อมูลเปรียบเทียบข้าม branch ที่ตรวจแล้ว (ยังไม่ทำงานใน Panussu)</strong></summary>

ข้อมูลต่อไปนี้ตรวจจาก [Kong19565 ที่ commit `df5632f`](https://github.com/Pongkarm/Future_Me/tree/df5632f156b60fec81ddf9712cbcb8d06b74ba05)
เมื่อ 16 สิงหาคม 2026 ข้อมูลเหล่านี้มีประโยชน์ต่อการเชื่อมระบบระยะถัดไป แต่ยังไม่ใช่ส่วนหนึ่งของระบบ Panussu ปัจจุบัน

| ข้อมูลใน branch Kong | ขอบเขตที่ตรวจได้ | เงื่อนไขก่อนนำมาอ้างว่าใช้ใน Panussu |
|---|---|---|
| **ส่วนต่อขยายแบบสอบถาม** | เรียงลำดับคงที่: ความสนใจ 30 ข้อ + self-efficacy ที่ทีมเขียน 6 ข้อ + บริบท 5 ข้อ รวม 41 ข้อก่อนหน้าทบทวน | ไม่ใช่ CAT, IRT, Akinator หรือการเลือกข้อจากคำตอบ และคำถามใหม่ 6 ข้อยังไม่ผ่าน validation |
| **ดัชนีหลักสูตร** | 23,257 ระเบียน: ปริญญาตรี 6,349, ปวช. 9,191 และ ปวส. 7,717 ครอบคลุม 993 สถาบันและ 269 สาขา | 15,586 ระเบียนมีข้อมูลผลลัพธ์ ส่วน 16,909 ระเบียนไม่มีข้อมูลต้นทุนการผลิต และต้นทุนการผลิตไม่ใช่ค่าเล่าเรียนที่ผู้เรียนจ่าย |
| **ตัวจับคู่หลักสูตร** | Core fit ใช้ cosine ของความสนใจ 70% + self-efficacy 30% เมื่อมีข้อมูล โดยบริบทขยับคะแนนได้ไม่เกิน 15 คะแนน และมีกฎปฏิเสธก่อนแสดงสูงสุด 5 หลักสูตร | น้ำหนักเหล่านี้เป็นกฎออกแบบ ไม่ได้ fit จากข้อมูลผลลัพธ์ ระบบนี้แยกจากเอนจินเส้นทาง 50/30/20 และไม่ได้ขับหน้าการเปรียบเทียบหรือแผน 30 วัน |
| **ช่องว่างของหลักฐาน** | ยังไม่มีค่าเล่าเรียนที่ผู้เรียนจ่าย รอบ/เกณฑ์/คะแนน TCAS ทุน หรือความช่วยเหลือการเงินรายหลักสูตรที่ตรวจสอบแล้ว | crosswalk ระหว่างสาขากับอาชีพสร้างโดยทีมและยังไม่ผ่านผู้เชี่ยวชาญ ส่วนค่าครองชีพ 5 ภาคเป็นค่าประมาณ |

ดังนั้นแผนภาพ AIS Cloud ที่ให้มาเป็น **สถาปัตยกรรมเป้าหมาย** ไม่ใช่แผนภาพระบบปัจจุบัน
การโฮสต์บน AIS Cloud, GPU, Qdrant, บัญชีผู้ใช้ แดชบอร์ดครูแนะแนว แอปมือถือแยก
feedback loop อัตโนมัติ และแฟ้มสะสมผลงาน TCAS ยังเป็นข้อเสนอ จนกว่าจะมี branch ที่พัฒนาและตรวจสอบจริง
...
- กฎ deterministic จากคำตอบแรกที่เลื่อนคำถามเดิม 2 ข้อมาแสดงก่อน โดยไม่เปลี่ยนคลัง 30 ข้อหรือสูตรคะแนน
...
- ชุดข้อมูลคำถามทดลอง 1,000 แถวสร้างจากข้อความตั้งต้น 148 ข้อ โดยบางข้อความซ้ำสูงสุด 19 ครั้ง ชุดนี้ผ่านการตรวจโครงสร้างแต่ยังไม่ใช้ในระบบจริง และยังต้องตรวจเนื้อหา ความเป็นธรรม การให้คะแนน และกฎแตกสาขากับผู้เชี่ยวชาญและนักเรียน
- กฎเลื่อนคำถามเดิม 2 ข้อมาแสดงก่อนเป็นฮิวริสติกของผลิตภัณฑ์ ไม่ใช่ CAT, IRT หรือหลักฐานว่าแบบประเมินแม่นยำขึ้น
...
<details>
<summary><strong>มีหลักฐานใดบอกว่าปัญหานี้สำคัญ และหลักฐานนั้นยืนยันว่า FutureMe ได้ผลหรือไม่?</strong></summary>

TDRI รายงานว่า 56% ของคนไทยที่มีการศึกษาสูงกว่ามัธยมปลายทำงานไม่ตรงสาขา และ 27% ทำงานต่ำกว่า
ระดับทักษะหรือคุณวุฒิ ส่วน WEF รายงานว่านายจ้างคาดว่าทักษะแกนหลัก 39% จะเปลี่ยนภายในปี 2030
ตัวเลขเหล่านี้ช่วยอธิบายปัญหา แต่ยังไม่พิสูจน์ว่า FutureMe มีประสิทธิผล ดู
[สรุปงานวิจัยพร้อมขอบเขต](01_Research/Data/01_Graduate_Unemployment_and_Mismatch_Stats/SUMMARY.md)
</details>
...
<details>
<summary><strong>Panussu ใช้ตัวจับคู่หลักสูตร 23,257 ระเบียนจาก branch Kong แล้วหรือยัง?</strong></summary>

ยัง Branch Kong19565 มีดัชนีดังกล่าวและตัวจับคู่แบบ deterministic ที่แสดงได้สูงสุด 5 หลักสูตร
แต่ Panussu ยังไม่ได้ import ไฟล์เหล่านั้น ผลปัจจุบันจึงยังเป็นสมมติฐานเส้นทางตัวอย่าง 0–3 ทาง
ส่วนสถานศึกษาใกล้เคียงเป็น directory หลังได้ผล และไม่มีสิทธิ์เปลี่ยนผลเส้นทาง
</details>
...
<details>
<summary><strong>แบบสัมภาษณ์ใช้ชุดข้อมูลคำถามทดลอง 1,000 แถวหรือไม่?</strong></summary>

ยังไม่ใช้ ข้อมูล 1,000 แถวนี้สร้างจากข้อความตั้งต้น 148 ข้อด้วยการเติมบริบท โดยบางข้อความซ้ำสูงสุด
19 ครั้ง ชุดข้อมูลถูกเก็บและตรวจโครงสร้างไว้สำหรับงานวิจัยระยะถัดไป แบบสัมภาษณ์ปัจจุบันยังใช้
คำถามที่ทบทวนแล้ว 30 ข้อจาก `questions.json` โดยคำตอบแรกเปลี่ยนเพียงว่าคำถามเดิม 2 ข้อใดจะ
แสดงต่อทันที กลไกนี้เป็นการจัดลำดับตามกฎ ไม่ใช่ CAT หรือ IRT
</details>
...
หน้าจอแสดงวันที่ของแค็ตตาล็อก เหตุผล ข้อมูลที่ยังไม่ทราบ และแหล่งที่มา
