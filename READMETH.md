...
<p align="center"><sub><strong>รุ่น 0.2.0</strong> · ตรวจทานเอกสาร สัญญาขอบเขตข้อมูล และไฟล์นำเสนอล่าสุดเมื่อ 11 สิงหาคม 2026</sub></p>
...
| **รุ่นปัจจุบันคืออะไร?** | FutureMe 0.2.0 และเอนจิน deterministic 0.2.0-prototype |
...
| **ทะเบียนรุ่นและข้อมูล** | รุ่น ขอบเขต Institution / Program / Admission / Financial / Location แหล่งที่มา วันที่ ช่องว่าง และขอบเขตการใช้ตัดสินใจ | ✅ ตรวจด้วยระบบอัตโนมัติ |
...
- ขอบเขตข้อมูลมีเวอร์ชันชัดเจน: สถานศึกษาต้นทาง 1,417 ระเบียน แสดงสถานศึกษาที่ไม่ซ้ำ 1,375 แห่ง มี 140 แห่งที่จับคู่เส้นทางจากข้อมูลหลักสูตร และยังไม่มีระเบียน admission หรือการเงินที่ตรวจสอบแล้วในระบบ
